...
.. raw:: html
  ...
  <form action="/_static/form/registro.php" method="post" onsubmit="return validateForm()">
   ...
   <div class="fieldcontainer">
   <label for="actividad">Elige la actividad que más te interesa:</label>
   <select id="actividad" name="actividad">
   <option></option>
   <option>Maratón de Traducción - Quechua</option>
   <option>Maratón de Traducción - Aymara</option>
   <option>Catálogo de Contenidos: Ciudadanía Digital</option>
   <option>Hacker's Space: Una imagen para Puno</option>
   <option>Taller: Desarrollo Ágil de Actividades de Sugar</option>
   </select>
   </div>
   ...
   <input style="background-color:red; color:white;" type="submit" value="Proceder con el Registro" />
   </div>
  </form>
